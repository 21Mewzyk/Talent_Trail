...
$adminid_official = $_SESSION['data']['id'];
$job_area_id = "";
$job_area_logo = "";
$job_area_title = "";
$sql2 = "SELECT * FROM tbl_jobareas WHERE admin_id = '$adminid_official'";
...
$query = "SELECT type, COUNT(*) AS count FROM tbl_accounts WHERE job_area_id = '$job_area_id' GROUP BY type";
...
if($islogin){
    if($u_type == 1){
        ...
        $load_jobs = mysqli_query($con,"SELECT *, a.id as job_id FROM `tbl_jobs` as a inner join tbl_accounts as b on a.userid = b.id WHERE b.job_area_id = '$job_area_id'");
        $count_jobs = mysqli_num_rows($load_jobs);

        $load_company = mysqli_query($con,"SELECT *, a.id as company_id FROM `tbl_company` as a inner join tbl_accounts as b on a.userid = b.id WHERE b.job_area_id = '$job_area_id'");
        ...
        if(form("manage")){
            ...
            if(is_numeric($id)){
                $manage_Job = mysqli_query($con,"SELECT *, a.id as job_id FROM `tbl_jobs` as a inner join tbl_accounts as b on a.userid = b.id WHERE b.job_area_id = '$job_area_id' AND a.id = '$id'");
        ...
        if(form("filter") && value("sub") == "applicants"){
            ...
            if($filter == "pending"){
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_applicants.status = 1 AND tbl_accounts.job_area_id = '$job_area_id'");
            }elseif($filter == "hired"){
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_applicants.status = 2 and tbl_applicants.is_archieve = 0  AND tbl_accounts.job_area_id = '$job_area_id'");
            }elseif($filter == "declined"){
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_applicants.status = 3 AND tbl_accounts.job_area_id = '$job_area_id'");
            }elseif($filter == "cancelled"){
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_applicants.status = 4 AND tbl_accounts.job_area_id = '$job_area_id'");
            }else{
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_accounts.job_area_id = '$job_area_id' ");
            }

            if(value("sub") == "is_archieve" ) {
                $load_applicants = mysqli_query($con,"SELECT tbl_applicants.id, tbl_applicants.applicantsid, tbl_accounts.firstname, tbl_accounts.lastname, tbl_accounts.cnum, tbl_accounts.bday, tbl_accounts.address, tbl_accounts.age, tbl_resume.path AS 'resume', tbl_applicants.companyid, tbl_applicants.jobid, tbl_jobs.j_name, tbl_applicants.status, tbl_applicants.created_at FROM tbl_applicants INNER JOIN tbl_accounts ON tbl_accounts.id = tbl_applicants.applicantsid INNER JOIN tbl_resume ON tbl_resume.userid = tbl_applicants.applicantsid INNER JOIN tbl_jobs ON tbl_jobs.id = tbl_applicants.jobid WHERE tbl_applicants.is_archieve = 1 AND tbl_accounts.job_area_id = '$job_area_id'");
            }
        ...
        if(form("view") && value("sub") == "company"){
            ...
            if(is_numeric($company_id)){
                ...
                WHERE
                    tbl_company.id =  $company_id AND tbl_accounts.job_area_id = '$job_area_id'
                ");
                if(hasResult($validate_company)){
                    ...
                    $load_company_reports = mysqli_query($con,"
                        ...
                        WHERE
                            `company_id` = $company_id AND tbl_accounts.job_area_id = '$job_area_id'
                    ");
                }else{
                    $company_view = false;
                }
        ...
        if(form("filter") && value("sub") == "list" && value("page") == "accounts"){
            ...
            if($filter == "all"){
                $load_accounts = mysqli_query($con,"SELECT * FROM `tbl_accounts` WHERE job_area_id = '$job_area_id' ORDER BY type ASC");
            }else{
                ...
                $load_accounts = mysqli_query($con,"SELECT * FROM `tbl_accounts` WHERE type = $account_type AND job_area_id = '$job_area_id' ORDER BY type ASC");
            }
        } elseif(value("sub") == "pending" && value("page") == "accounts"){ 
            $load_accounts = mysqli_query($con,"SELECT * FROM `tbl_accounts` WHERE status_id = 0 AND job_area_id = '$job_area_id' ORDER BY type ASC");
        }
        else{
            $load_accounts = mysqli_query($con,"SELECT * FROM `tbl_accounts` WHERE job_area_id = '$job_area_id' ORDER BY type ASC");
        }
        ...
        <div class="header"  >
            <div class="box">
                <a href="../../" class="header_logo">
                    ...
                    <p style="margin-bottom:0;"><?php echo $job_area_title; ?></p>
                </a>
                <span></span>
            ...
            <div class="navigation desktop_icon_profile">
            <button class="btn_user" style="border-radius: 2rem; padding: .5rem 2rem; background: #112D4E; color: white; border: none; cursor: pointer;">
...
<link href="https://fonts.googleapis.com/css2?family=Lato:ital,wght@0,100;0,300;0,400;0,700;0,900;1,100;1,300;1,400;1,700;1,900&display=swap" rel="stylesheet">
                ...
                <h2 style="font-family: 'Lato', sans-serif;">Hi, <?= $u_fname." ". $u_lname ?> 👋</h2>
                <div class="dashboard">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-12">
                                <div class="box" style="display:block; margin-bottom:2vh;">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <center>
                                            <div class="box_name" style="font-weight:bold; font-family: 'Lato', sans-serif;  font-size:2vh;">
                                                Open Jobs
                                            </div>
                                            <div class="box_count" style="font-weight:bold; font-family: 'Lato', sans-serif; font-size:2.5vh;">
                                                <?= $count_jobs ?>
                                            </div>
                                            </center>
                                        </div>
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="box"  style="display:block;">
                                    ...
                                    <hr>
                                    <center>
                                    <a href="?page=hire&sub=company"  style="background-color:white; color:black;">
                                    VIEW
                                    </a>
                                    </center>
                                </div>
            ...
            <script>
               var ctx = document.getElementById('userPieChart').getContext('2d');
                ...
                var data = {
                    ...
                    datasets: [{
                        data: [userCounts['2'] || 0, userCounts['3'] || 0],
                        ...
                        <div class="col-md-12">
                            <div class="container" style="width:100%; max-width:100%;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                            <a href="?page=hire&sub=postajob&manage=<?= $row["id"]?>" class="box" style="border:1px solid black; border-radius:2vh; margin-bottom:1vh; margin-top:1vh; min-height: 20vh;">
                                                <div class="text">
                            ...
                            <div class="container" style="margin-top:-2vh; width:100%; max-width:100%;">
                                ...
                                <div class="row">
                                    <div class="col-md-9">
                                        ...
                                        <label>Job ID</label>
                                        <div class="field">
                                            <input type="text" name="id" value="<?= ($update) ? $data["job_id"] : "" ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($update) {?>
                                    <button data-id="<?= ($update) ? $data["job_id"] : "" ?>" class="btn_delete_job" style="font-size:1.5vh; width:100%;">
                                    DELETE
                                    </button>
                                    <?php }?>
                                        </div>
                                    ...
                                    <div class="container_body">
                                        ...
                                        <?php if($action == "overview"){?>
                                            <form method="post" style="margin: 1rem" autocomplete="off">
                                                ...
                                                <div class="field">
                                                    <label for="name" style="text-align:right; margin-right:1vh;">Contact number</label>
                                                    <input type="text" id="name" name="tb_cnum" placeholder="Contact number" value="<?= $company_cnum ?>" readonly>
                                                </div>
                                                <div class="field">
                                                    <label for="name" style="text-align:right; margin-right:1vh;">Publisher's name</label>
                                                    <input type="text" id="name" name="tb_publisher_name" placeholder="Publisher's name" value="<?= $publisher_name ?>" readonly>
                                                </div>
                                                <div class="field">
                                                    <label for="name" style="text-align:right; margin-right:1vh;">Publisher's position</label>
                                                ...
                                                <div class="field">
                                                    ...
                                                    <input type="text" id="name" name="tb_created_at" placeholder="Created at" value="<?= date("M d, Y h:i A", strtotime($company_created_at)) ?>" readonly>
                                                </div>
                                            </form>
                                            ...
                                            <?php while($row = mysqli_fetch_assoc($load_company_reports)){?>
                                                <div class="box">
                                                    <div class="text">
                                                        ...
                                                        <p style="font-size: .8rem; margin-bottom: 1rem"><?= date("M d, Y h:i A", strtotime($row["created_at"])) ?></p>
                                    ...
                                    <div class="container_body" style="width:100% !important; max-width: 100% !important;">
                                        ...
                                        <?php if(hasResult($load_company)){?>
                                            <?php while($row = mysqli_fetch_assoc($load_company)){?>
                                                ...
                                                <a href="?page=hire&sub=company&view=<?= $row["company_id"] ?>" class="box" style="border:1px solid black; border-radius:2vh; margin:2vh; min-height: 25vh;">
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <img src="../../assets/images/<?php echo $row["c_logo"]; ?>" style="border-radius:50%; width:10vh; height:10vh; border:1px solid gray;">
                                                        </div>
                                                        ...
                                                        <div style="text-align: center;">
                                                            <span style="background-color: #623ADA; color: white; padding: 12px; border-radius: 1vh; margin-left: 150px;">View</span>
                                                        </div>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <?php if(hasResult($load_applicants)){?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="box" style="border:1px solid black; border-radius:2vh; margin-bottom:1vh; margin-top:1vh; min-height: 25vh;">
                                                <div class="text">
                                                    <p class="j_name">
                                                        ...
                                                        <div class="box" style="border:1px solid black; border-radius:2vh; margin:2vh; min-height: 35vh;">
                                                            <div class="text">
                                                                <p class="s_name" style="font-weight:bold;">
                                                                    <span class="label" style="font-weight:normal;">Full name : </span>
                                                                    <?= $row['firstname']; ?> <?= $row['middle_name']; ?> <?= $row['lastname']; ?> <?= $row['suffix']; ?>
                                                                </p>
                                                                <p class="posted_at">
                                                                ...
                                                                <?php if($row["type"] == 2){?>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <?php if(isset($datauserdocuments["c_doc1"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 1vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc1"]; ?>" download style="color: white; padding: 12px 15px; background-color: #36344d; border-radius: 10px; font-size: 1vh; display: block; text-align: center;">
                                                                            Letter of Intent
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc2"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 1vh;">
                                                                                <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc2"]; ?>" download style="color: white; padding: 12px 15px; background-color: #36344d; border-radius: 10px; font-size: 1vh; display: block; text-align: center;">
                                                                        ...
                                                                        <?php if(isset($datauserdocuments["c_doc3"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="margin-bottom: 1vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc3"]; ?>" download style="color: white; padding: 12px 15px; background-color: #36344d; border-radius: 10px; font-size: 1vh; display: block; text-align: center;">
                                                                            BIR Form 2303
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc4"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc4"]; ?>" download style="color: white; padding:12px; background-color: #36344d; padding-left: 15px; padding-right: 15px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh;">
                                                                            Business Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc5"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc5"]; ?>" download style="color: white; padding:12px; background-color: #36344d; padding-left: 15px; padding-right: 15px;border-radius: 10px; font-size:1vh;width:100% !important; margin-bottom:1vh;">
                                                                            SEC / DTI Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc6"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc6"]; ?>" download style="color: white; padding:12px; background-color: #36344d; padding-left: 15px; padding-right: 15px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh;">
                                                                            License Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                ...
                                                                <button type="button" class="edit-button" onclick="openConfirmModal1('<?= $row["id"] ?>')" style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px;">EDIT</button>

                                                                <div class="modal fade" id="openConfirmModal<?= $row["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                                        <div class="modal-content" style="margin-top:15vh; width:25%; height:25%; border-radius:1vh;">
                                                                            <center>
                                                                            <div class="modal-body">
                                                                                <div class="swal2-icon swal2-question swal2-icon-show" style="display: flex;"><div class="swal2-icon-content">?</div></div>
                                                                                <br>
                                                                                <h2 class="swal2-title">Are you sure you want to modify this account?</h2>
                                                                            </div>
                                                                            <br>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="swal2-confirm swal2-styled" id="confirmEdit" style="padding: .625em 1.1em; display: inline-block;border: 0;border-radius: .25em;background: initial;background-color: #7066e0;color: #fff;font-size: 1em;" onclick="openEditDiv1('<?= $row["id"] ?>')">Yes</button>
                                                                                <button type="button" class="swal2-cancel swal2-styled" data-dismiss="modal" style="padding: .625em 1.1em; display: inline-block;border: 0;border-radius: .25em;background: initial;background-color: #6e7881;color: #fff;font-size: 1em;" onclick="closeConfirmModal1('<?= $row["id"] ?>')">Cancel</button>
                                                                            </div>
                                                                            </center>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="edit-div" id="editDiv<?= $row["id"] ?>" style="display: none; width:100%;  border: 1px solid #000; padding:10px; border-radius:1vh; margin-top:2vh;">
                                                                    <!-- Form for editing -->
                                                                    <form id="editFormAdmin<?= $row["id"] ?>" method="post" onsubmit="editadminaccount(event, <?= $row["id"] ?>)">
                                                                        <input type="hidden" name="admin_id" value="<?= $row["id"] ?>" />
                                                                        <input type="hidden" name="previous_handled" value="<?php echo $previous_handled; ?>" />
                                                                        ...
                                                                        <div class="field">
                                                                          ...
                                                                          <div class="field">
                                                                            ...
                                                                            <input type="number" class="form-control" id="cnum" name="cnum" maxlength="11"  value="<?php echo $row["cnum"]; ?>" required>
                                                                        </div>
                                                                          <div class="field">
                                                                            <label for="bday">Birth Date:</label>
                                                                            <input type="date" class="form-control" id="bday" name="bday"  value="<?php echo $row["bday"]; ?>" required>
                                                                        </div>
                                                                          <div class="field">
                                                                        ...
                                                                        <div class="field">
                                                                            <label for="jobarea_id" style="text-align:left;">Assign Job Area:</label>
                                                                            <select id="jobarea_id" name="jobarea_id">
                                                                                <option value="" selected>Select New Job Area</option>
                                                                                <?php
                                                                        ...
                                                                        <button type="submit" class="edit-button" style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px; width:50%; margin-left:16%;">Save Changes</button>
                                                                    </form>
                                                        ...
                                                        <button type="button" id="<?php  echo $row["id"]?>" onclick="updateAccountStatus(this.id,this.name)" name="1"   style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px;">ACCEPT</button>
                                                                ...
                                                                <?php if($row["type"] == 2){?>
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <?php if(isset($datauserdocuments["c_doc1"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc1"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh;">
                                                                            Letter of Intent
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc2"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc2"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh; ">
                                                                            Company Profile
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc3"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc3"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh;">
                                                                            BIR Form 2303
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc4"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc4"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:1vh; width:100% !important; margin-bottom:1vh;">
                                                                            Business Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc5"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc5"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:1vh;width:100% !important; margin-bottom:1vh;">
                                                                            SEC / DTI Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
                                                                        <?php if(isset($datauserdocuments["c_doc6"])){ ?>
                                                                            <div class="col-md-4 col-xs-12" style="width:100% !important; margin-bottom:2vh;">
                                                                        <a href="../../assets/documents/<?php echo $datauserdocuments["c_doc6"]; ?>" download style="color: white; padding:10px; background-color: #36344d; padding-left: 5px; padding-right: 5px;border-radius: 10px; font-size:2vh; width:100% !important; margin-bottom:1vh;">
                                                                            License Permit
                                                                        </a>
                                                                    </div>
                                                                        <?php } ?>
        ...
        flex: 0 0 100%; /* Do not grow, do not shrink, take 100% width */
        max-width: 100%;
    }
    ...
    .col-md-8 {
        flex: 0 0 66.66667%; /* Do not grow, do not shrink, take 66.66667% width */
        max-width: 66.66667%;
    }
                }
                            ...
                            <div class="showcase" id="showcase_sub_list">
                             <div class="container">
                                    ...
                                    <div class="container_body">
                                        ...
                                        $sql = "SELECT * FROM tbl_jobareas WHERE admin_id = '$my_id'";
                                        $result = mysqli_query($con, $sql);
                                        if ($result) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                        ?>
                                        ...
                                        <div class="row">
                                                    <div class="col-md-4 col-xs-12">
                                                        ...
                                                        <?php if($row['logo_area'] != ''){ ?>
                                                            <img style="width:13vh; height:13vh; border-radius:50%;" src="../../assets/images/<?php echo $row['logo_area']; ?>" alt="logo" />
                                                        <?php } ?>
                                                    ...
                                                    <div class="col-md-8 col-xs-12">
                                                        ...
                                                        <br>
                                                        <center>
                                                        <button type="button" id="<?php echo $row["id"]?>" onclick="deleteArea(this.id)"  style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px;">DELETE</button>



                                                        <button type="button" class="edit-button" onclick="openConfirmModal2('<?= $row["id"] ?>')" style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px;">EDIT</button>
                                                        </center>

                                                        <div class="modal fade" id="openConfirmModal2<?= $row["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content" style="margin-top:15vh; width:25%; height:25%; border-radius:1vh;">
                                                                    <center>
                                                                    <div class="modal-body">
                                                                        <div class="swal2-icon swal2-question swal2-icon-show" style="display: flex;"><div class="swal2-icon-content">?</div></div>
                                                                        <br>
                                                                        <h2 class="swal2-title">Are you sure you want to modify this job area?</h2>
                                                                    </div>
                                                                    <br>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="swal2-confirm swal2-styled" id="confirmEdit" style="padding: .625em 1.1em; display: inline-block;border: 0;border-radius: .25em;background: initial;background-color: #7066e0;color: #fff;font-size: 1em;" onclick="openEditDiv2('<?= $row["id"] ?>')">Yes</button>
                                                                        <button type="button" class="swal2-cancel swal2-styled" data-dismiss="modal" style="padding: .625em 1.1em; display: inline-block;border: 0;border-radius: .25em;background: initial;background-color: #6e7881;color: #fff;font-size: 1em;" onclick="closeConfirmModal2('<?= $row["id"] ?>')">Cancel</button>
                                                                    </div>
                                                                    </center>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <br>
                                                        <div class="edit-div" id="editDiv2<?= $row["id"] ?>" style="margin-left:auto; display: none; width:100%; border: 1px solid #000; padding:10px; border-radius:1vh;">
                                                            <!-- Form for editing -->
                                                            <form id="editForm<?= $row["id"] ?>" method="post" onsubmit="editLocations(event, <?= $row["id"] ?>)" enctype="multipart/form-data">
                                                                <input type="hidden" name="area_id" value="<?= $row["id"] ?>">

                                                                <div class="field">
                                                                    <label for="logo">Upload New Logo:</label>
                                                                    <input type="file" class="form-control" id="logo" name="logo" style="display:block;">
                                                                </div>
                                                                <div class="field">
                                                                    <label for="titlearea">Area Title:</label>
                                                                    <input type="text" class="form-control" id="titlearea" name="titlearea" value="<?= $row["title_area"] ?>" required>
                                                                </div>

                                                                <div class="field">
                                                                    <label for="titlearea">Location:</label>
                                                                    <select class="form-control" id="editLocation" name="editLocation" required>
                                                                ...
                                                                <div class="field">
                                                                    <label for="editDescription" style="text-align:left;">Description:</label>
                                                                    <textarea class="form-control" id="editDescription" name="editDescription"><?= $row["Description"] ?></textarea>
                                                                </div>
                                                                <div class="field">
                                                                    <label for="handledby" style="text-align:left;">Handled By:</label>
                                                                    <select id="handledby" name="handledby">
                                                                        <?php if($row['admin_id'] != ''){ ?>
                                                                            <option value="<?php echo $admin_id; ?>" selected><?php echo $admin_name;?></option>
                                                                        <?php }else{ ?>
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            if ($result3) {
                                                                                ...
                                                                                {
                                                                                ?>
                                                                                <option value="<?php echo $row3['id']; ?>"><?php echo $row3['firstname'].' '.$row3['lastname']; ?></option>
                                                                        <?php } } ?>
                                                                        <?php if($row['admin_id'] != ''){ ?>
                                                                ...
                                                                <center>
                                                                <button type="submit" class="edit-button" style="color: white; padding:10px; background-color: #36344d; padding-left: 30px; padding-right: 30px;border-radius: 10px; width:50%;">Save Changes</button></center>
                                                            </form>

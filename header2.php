...
<div class="header" style="background-color:#F9F7F7;">
    <div class="text">
        <a href="/<?= $__name__ ?>" class="header_logo">
            ...
            <p  style="color:black; margin-top:1.5vh;"><?php echo $job_area_title; ?></p>
                <?php
            }else{ ?>
            <img src="/<?= $__name__ ?>/assets/LOGO.png" alt="logo">
            <p style="margin-top:1.5vh;">Talent Trail</p>
        <?php } ?>
        </a>
    ...
    <div class="navigation">
        <?php if($islogin){?>
            ...
            <?php }elseif($u_type == 3){?>
                <a href="/<?= $__name__ ?>">HOME</a>
                <a href="/<?= $__name__ ?>/jobs">JOBS</a>
                <a href="/<?= $__name__ ?>/appliedjobs">TRACK APPLICATIONS</a>
        ...
        <?php }else{?>
            ...
            <a href="/<?= $__name__ ?>/jobs">JOBS</a>
            <a href="/<?= $__name__ ?>/contact_us.php">CONTACT US</a>
            <a href="/<?= $__name__ ?>/ResumePage.php">RESUME BUILDER</a>
